...
export function EditAnnouncementModal({ open, onOpenChange, announcement, onSuccess }: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update the announcement details and content.</DialogDescription>
        </DialogHeader>
